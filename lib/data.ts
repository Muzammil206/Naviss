...
export const TEAM = [
  {
    ...
    expertise: ["Geospatial Strategy", "WebGIS Architecture", "PostGIS / PostgreSQL", "Python / Django", "AWS / Azure", "Spatial APIs"],
  ...
  {
    id: "002",
    name: "Dahir Muazu Omar",
    role: "co-founder & Lead GIS Developer",
    shortBio: "Full-stack geospatial developer specializing in Next.js, PostGIS, and scalable spatial data infrastructure.",
    bio: "Ismail architects and builds Naviss's flagship platforms, from multi-country data portals to real-time environmental monitoring systems. He brings expertise in modern web frameworks, spatial databases, and cloud infrastructure. His work on the West Africa GeoPortal serves thousands of users daily across 6 countries.",
     expertise: ["Geospatial Strategy", "Land Administration", "WebGIS Architecture", "Client Engagement"],
    image: "/myimage.pg?w=800&q=85",
    email: "ismail@naviss.tech",
    linkedin: "https://linkedin.com/in/ismailmuzammil",
  },
  {
    id: "003",
  ...
  },
  {
    ...
    shortBio: " Abdulsalam is a Geospatial Expert and Co-Founder with over 5 years of experience driving precision in the surveying and geoinformatics industry. With a Bachelor’s degree in Surveying and Geoinformatics, Abdulsalam has built a career defined by technical versatility, spanning Land Surveying, Hydrography, and specialized operations within the Oil and Gas sector. Throughout his career, he has mastered the art of translating complex spatial data into actionable insights. Now, as Co-Founder, Abdulsalam leverages his deep field experience to lead Naviss Technologies’ operational strategy, ensuring that technical excellence meets scalable business growth.",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-151908560753-af0119f7cbe7?w=800&q=85",
